...
import { LayoutDashboard, Users, Bell, Calendar, BookOpen, MessageCircle, BarChart3 } from "lucide-react";
    ...
    <Sidebar collapsible="icon">
      <SidebarContent>
        <div className="p-4">
          ...
          {!collapsed && <p className="text-xs text-muted-foreground">Parent Portal</p>}
        </div>
        <SidebarGroup>
